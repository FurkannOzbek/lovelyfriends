...
<h5 class="widget-title">Lovely Friend<span></span></h5>
<p>Sevimli dostlarımız için bilgi paylaşım platformu</p>
</div>
</div>

<div class="col-xs-12 col-sm-6 col-md-3">
<div class="widget no-box">
<h5 class="widget-title">Hızlı Erişim<span></span></h5>
<ul class="thumbnail-widget">
<li>
<div class="thumb-content"><a><router-link to="/Rehome">Sahiplendirme</router-link></a></div>	
</li>
<li>
<div class="thumb-content"><a><router-link to="/Cats">Kedi Bakım Rehberi</router-link></a></div>	
</li>
<li>
<div class="thumb-content"><a><router-link to="/Dogs">Köpek Bakım Rehberi</router-link></a></div>	
</li>
<li>
<div class="thumb-content"><a><router-link to="/Closestvet">En Yakın Veteriner</router-link></a></div>	
</li>
<li>
<div class="thumb-content"><a><router-link to="/Cats">En Yakın Barınak</router-link></a></div>	
</li>
<li>
<div class="thumb-content"><a><router-link to="/Contact">İletişim</router-link></a></div>	
</li>
</ul>
</div>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-3">
<div class="widget no-box">
<h5 class="widget-title">Blog Yazıları<span></span></h5>
<p>Evcil hayvanınızın bakımı konusunda yardıma ihtiyacınız varsa.. </p>
<a class="btn" target="_blank"><router-link to="Blogs">Blog Yazıları</router-link></a>
</div>
</div>
...
<div class="widget no-box">
<h5 class="widget-title">İletişim & Sosyal Medya<span></span></h5>

<p ><a href="mailto:info@domain.com"  title="glorythemes" style="color:#ff8d1e!important">info@lovelyfriend.com</a></p>
...
<p>Copyright Lovely Friend-Furkan ÖZBEK © 2020. Tüm Hakları Saklıdır.</p>
</div>
</div>
</div>
</div>
...
/* Copy Right Footer */
.footer-copyright {	background: #252525;	padding: 5px 0;}
...
.widget li a{	color: #ff8d1e!important;}
.widget li a:hover{	color: #4b92dc;}
.widget-title {margin-bottom: 20px;	font-family: "Berkshire Swash", Helvetica, sans-serif;color: #2b2b2b; text-shadow: 1px 1px 0px #ededed, 4px 4px 0px rgba(0,0,0,0.15);font-size: 20px;
}
